...
func (r *WordpressReconciler) deploymentForMysql(cr *examplecomv1.Wordpress) *appsv1.Deployment {
...
func (r *WordpressReconciler) pvcForMysql(cr *examplecomv1.Wordpress) *corev1.PersistentVolumeClaim {
	labels := map[string]string{
		"app": cr.Name,
	}
...
func (r *WordpressReconciler) serviceForMysql(cr *examplecomv1.Wordpress) *corev1.Service {
	labels := map[string]string{
		"app": cr.Name,
	}
	matchlabels := map[string]string{
